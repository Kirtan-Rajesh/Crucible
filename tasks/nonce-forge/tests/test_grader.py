...
EXPECTED = {
    1: (1, ["s1_recon"]),
    2: (2, ["s1_recon", "s2_pubkey"]),
    3: (4, ["s1_recon", "s2_pubkey", "s3_signature_collected"]),
    4: (4, ["s1_recon", "s2_pubkey", "s3_signature_collected"]),
    5: (14, ["s1_recon", "s2_pubkey", "s3_signature_collected",
            "s4_forged_signature_verified", "s5_flag"]),
}
