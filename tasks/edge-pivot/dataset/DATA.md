# Training data — edge-pivot

Generated by `python -m harness.cli export edge-pivot`. Regenerate any time;
...
- **rl.jsonl** (100 rollouts, 47 solved) — stochastic-agent rollouts
...
of 14 total. Stages:
  ...
  - `s1_recon` (weight 1)
  - `s2_privesc` (weight 2)
  - `s3_ssrf_pivot` (weight 3)
  - `s4_exfil_key` (weight 3)
  - `s5_flag` (weight 5)
